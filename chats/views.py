...
from chats.forms import FormularioIniciarConversacion, FormularioEnvioMensaje
...
# Búsqueda de TODAS las conversaciones recibidas e iniciadas por el usuario
    ...
    return render(request, 'chats/ver_conversaciones.html', { 'chats' : chats })
...
# Disponibiliza SÓLO aquellos usuarios con los que puedo iniciar una conversación
    ...
    return render(request, 'chats/iniciar_chat.html', { 'formulario_iniciar_chat' : formulario_iniciar_chat })
...
# Esta vista disponibiliza la conversación con el usuario, y permite enviar un nuevo mensaje
    ...
    return render(request, 'chats/ver_chat.html', { 'formulario_envio_mensaje' : formulario_envio_mensaje, 'chat' : chat, 'mensajes' : mensajes })

class EliminarChatView(LoginRequiredMixin, DeleteView):
    model         = Chat
    template_name = 'chats/borrar_chat.html'
    success_url   = '/chats/'